const TurkeyLocations = {
    provinces: [
        ...
        { id: 43, name: "Kütahya", districts: ["Altıntaş", "Aslanapa", "Çavdarhisar", "Domaniç", "Dumlupınar", "Emet", "Gediz", "Hisarcık", "Merkez", "Pazarlar", "Simav", "Şaphane", "Tavşanlı"] },
        ...
        { id: 71, name: "Kırıkkale", districts: ["Bahşılı", "Balışeyh", "Çelebi", "Delice", "Karakeçili", "Keskin", "Merkez", "Sulakyurt", "Yahşihan"] },
        ...
        { id: 81, name: "Düzce", districts: ["Akçakoca", "Cumayeri", "Çilimli", "Gölyaka", "Gümüşova", "Kaynaşlı", "Merkez", "Yığılca"] },
                { id: 82, name: "Kıbrıs", districts: ["Lefkoşa", "Gazimağusa", "Girne", "Güzelyurt", "İskele", "Lefke"] }
    ],
    airports: {
        "Adana": ["Adana Havalimanı (ADA)", "Çukurova Uluslararası Havalimanı (COV)"],
        ...
        "Ankara": ["Ankara Esenboğa Havalimanı (ESB)"],
        ...
        "Balıkesir": ["Balıkesir Koca Seyit Havalimanı (EDO)", "Balıkesir Merkez Havalimanı (BZI)"],
        "Batman": ["Batman Havalimanı (BAL)"],
        "Bingöl": ["Bingöl Havalimanı (BGG)"],
        "Bursa": ["Bursa Yenişehir Havalimanı (YEI)"],
        "Çanakkale": ["Çanakkale Havalimanı (CKZ)", "Gökçeada Havalimanı (GKD)"],
        ...
        "Giresun": ["Ordu-Giresun Havalimanı (OGU)"],
        ...
        "İzmir": ["İzmir Adnan Menderes Havalimanı (ADB)"],
        ...
        "Kocaeli": ["Kocaeli Cengiz Topel Havalimanı (KCO)"],
        "Konya": ["Konya Havalimanı (KYA)"],
        "Kütahya": ["Zafer Havalimanı (KZR)"],
        "Malatya": ["Malatya Erhaç Havalimanı (MLX)"],
        "Mardin": ["Mardin Prof. Dr. Aziz Sancar Havalimanı (MQM)"],
        "Mersin": ["Çukurova Uluslararası Havalimanı (COV)"],
        "Muğla": ["Dalaman Havalimanı (DLM)", "Milas-Bodrum Havalimanı (BJV)"],
        "Muş": ["Muş Sultan Alparslan Havalimanı (MSR)"],
  ...
  "Ercan Havalimanı (ECN)"
    ...
    getDistricts: function (provinceName) {
        ...
        return province ? province.districts.sort((a, b) => a.localeCompare(b, 'tr')) : [];
    },
    getAirports: function (provinceName) {
        return this.airports[provinceName] || [];
    }
};
